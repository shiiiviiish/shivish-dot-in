    ...
    <>
      <motion.div
        ...
        <AnimatePresence>
          {phase === 'touring' && (
            <motion.div
              ...
              <p style={{ fontFamily: serif, fontStyle: 'italic', fontSize: 14, color: 'rgba(232,228,217,0.8)', lineHeight: 1.7, marginBottom: 16 }}>"{tourStops[step].msg}"</p>
              <div style={{ display: 'flex', gap: 8 }}>
        ...
        <motion.button
          ...
          <img src="/images/shivishanimated.png" alt="Shivish" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center top', transform: 'scale(1.15)' }} />
